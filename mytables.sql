...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 26, 2025 at 11:54 PM
...
CREATE TABLE `orders` (
  ...
  `payment_method` enum('EFT','Credit Card') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `payments` (
  ...
  `method` enum('eft','credit','debit') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `products`
  ADD CONSTRAINT `fk_products_category` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
